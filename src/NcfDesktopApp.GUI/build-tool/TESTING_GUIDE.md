...
# 2. 进入工具目录
cd Y:\SenparcProjects\NeuCharFramework\NcfDesktop\src\NcfDesktopApp.GUI\build-tool
...
```powershell
cd Y:\SenparcProjects\NeuCharFramework\NcfDesktop\src\NcfDesktopApp.GUI\publish-self-contained\win-arm64-final
